...
public class SetActivity extends Activity {
  ...
  private void drawUi() {
    ...
    setActivity.setDisplay.addView(PublicTools.createSwitchCard(this, getString(R.string.set_display_auto_sync_orientation), getString(R.string.set_display_auto_sync_orientation_detail), AppData.setting.getAutoSyncOrientation(), isChecked -> AppData.setting.setAutoSyncOrientation(isChecked)).getRoot());
